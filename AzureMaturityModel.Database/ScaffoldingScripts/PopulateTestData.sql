...
BEGIN
	...
	INSERT INTO MaturityMetric(MaturityMetricId, MetricCategoryId, MaturityMetricName, [Description]) VALUES(15,2,'DNS automation completed', 'Description')
	...
	INSERT INTO MaturityMetric(MaturityMetricId, MetricCategoryId, MaturityMetricName, [Description]) VALUES(24,5,'Technical solution implemented', 'Description')
	INSERT INTO MaturityMetric(MaturityMetricId, MetricCategoryId, MaturityMetricName, [Description]) VALUES(25,5,'DR solution successfully tested', 'Description')
	INSERT INTO MaturityMetric(MaturityMetricId, MetricCategoryId, MaturityMetricName, [Description]) VALUES(26,6,'WAF enabled', 'Description')
	INSERT INTO MaturityMetric(MaturityMetricId, MetricCategoryId, MaturityMetricName, [Description]) VALUES(27,6,'Dynamic/static code scanning', 'Description')
	INSERT INTO MaturityMetric(MaturityMetricId, MetricCategoryId, MaturityMetricName, [Description]) VALUES(28,6,'Privileged access security managed', 'Description')
	INSERT INTO MaturityMetric(MaturityMetricId, MetricCategoryId, MaturityMetricName, [Description]) VALUES(29,6,'TLS 1.2 enabled', 'Description')
	INSERT INTO MaturityMetric(MaturityMetricId, MetricCategoryId, MaturityMetricName, [Description]) VALUES(30,6,'KeyVault sourced sensitive values', 'Description')
	INSERT INTO MaturityMetric(MaturityMetricId, MetricCategoryId, MaturityMetricName, [Description]) VALUES(31,6,'SQL accounts under DBA control', 'Description')
	INSERT INTO MaturityMetric(MaturityMetricId, MetricCategoryId, MaturityMetricName, [Description]) VALUES(32,6,'SIEM application logs imtegrated', 'Description')
	INSERT INTO MaturityMetric(MaturityMetricId, MetricCategoryId, MaturityMetricName, [Description]) VALUES(33,6,'SIEM database logs integrated', 'Description')
END
